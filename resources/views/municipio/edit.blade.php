...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="text" required class="form-control" id="name" name="name" placeholder="Municipio name." name="name" value="{{ $municipio->muni_codi }}">
  </div>
  ...
  <div class="mb-3">
    ...
    <a href="{{ route('municipios.index') }}" class="btn btn-waening">Cancel</a>
  </div>
</form>
    </div>
