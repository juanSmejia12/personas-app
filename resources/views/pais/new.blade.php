...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="text" required class="form-control" id="capital" aria-describedby="nameHelp" name="capital" placeholder="Capital del pais.">
  </div>

  <div class="mb-3">
    <button type="submit" class="btn btn-primary">Save</button>
    <a href="{{ route('paises.index') }}" class="btn btn-waening">Cancel</a>
  </div>
</form>
    </div>
