...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="text" required class="form-control" id="name" name="name" placeholder="Departamento name." name="name" value="{{ $departamento->depa_codi }}">
  </div>
  ...
  <div class="mb-3">
    ...
    <a href="{{ route('departamentos.index') }}" class="btn btn-waening">Cancel</a>
  </div>
</form>
    </div>
