...
<html lang="en">
  ...
  <div class="mb-3">
    ...
    <input type="text" required class="form-control" id="name" name="name" placeholder="Comuna name." name="name" value="{{ $comuna->comu_codi }}">
  </div>
  ...
  <div class="mb-3">
    ...
    <a href="{{ route('comunas.index') }}" class="btn btn-waening">Cancel</a>
  </div>
</form>
    </div>
